...
// carries the same band spells and must get the same effect (docs/era-talents-framework.md, the bot Judgement no-op).
...
// carries the same band spells and must get the same behaviour (docs/era-talents-framework.md, the bot Judgement no-op).
...
// (docs/era-talents-framework.md "Era proc/effect scripts must NOT bail on bots"), which is exactly what the code does.
...
// be excluded (the bot-Judgement no-op regression, docs/era-talents-framework.md "Era proc/effect scripts must NOT bail
// on bots").
...
// gate docs/era-talents-framework.md's "Era proc/effect scripts must NOT bail on bots" paragraph prescribes: NEVER a
...
//
// Gated on `Enabled()` + a live caster ONLY — never on "is a bot" (docs/era-talents-framework.md: an era-managed bot
...
// — and it must NOT gate on "is a bot" (docs/era-talents-framework.md: an era-managed bot owns this clone and needs the
