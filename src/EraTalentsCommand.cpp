...
public:
    ...
    static bool HandleDoctor(ChatHandler* handler, Optional<PlayerIdentifier> player)
    {
        ...
        bool const targetIsBot = EraTalentBots::IsBot(t);
        ...
        // Playerbots-only: the bridge (patch 0021) exists only when mod-playerbots is compiled in.
...
#else
        handler->PSendSysMessage("  AI resolve: n/a (built without mod-playerbots)");
#endif
