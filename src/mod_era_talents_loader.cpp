...
public:
    ...
    void OnStartup() override
    {
        ...
        if (sEraTalentsConfig->BotTalents())
            LOG_WARN("module", "[mod-era-talents] EraTalents.BotTalents=1 but this build has no mod-playerbots — bot era talents are unavailable");
#endif
