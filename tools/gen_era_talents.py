...
# malformed SpellInfo). Resolved relative to this script (drop a pristine 3.3.5a Spell.dbc at
# client-patch/base/Spell.dbc); overridable via $ERA_BASE_SPELL_DBC or --base-dbc.
DEFAULT_BASE_DBC = pathlib.Path(os.environ.get(
    "ERA_BASE_SPELL_DBC",
    str(pathlib.Path(__file__).resolve().parent.parent / "client-patch" / "base" / "Spell.dbc")))
